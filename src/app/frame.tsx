    ...
    <div className='py-10'>
     <div className='py-16 px-20 bg-[#FAF3EA] '>
        ...
        <div className='flex gap-2'>
            <Image src={'/cup.png'} alt='' width={60} height={58.13} />
