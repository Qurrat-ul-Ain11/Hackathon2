  ...
  return (
    <>
      ...
      <div className="w-full md:hidden block p-6 bg-[#F9F1E7] mb-3">
        <Image src={'/sofa1.png'} alt={"sofa"} width={600} height={600} className="w-full h-full object-cover" />
      </div><div className="flex md:flex-col flex-row md:gap-5 gap-3">
        <span className="w-32 md:h-28 bg-[#F9F1E7] p-4">
        <Image src={'/sofa5.png'} alt={"sofa"} width={600} height={600} className="w-full h-full object-cover" />
        </span>
        <span className="w-32 md:h-28 bg-[#F9F1E7] p-4">
        <Image src={'/sofa6.png'} alt={"sofa"} width={600} height={600} className="w-full h-full object-cover" />
        </span>
        <span className="w-32 md:h-28 bg-[#F9F1E7] p-4">
        <Image src={'/sofa7.png'} alt={"sofa"} width={600} height={600} className="w-full h-full object-cover" />
        </span>
        <span className="w-32 md:h-28 bg-[#F9F1E7] p-4">
          <Image src={'/sofa8.png'} alt={""} width={600} height={600} className="w-full h-full object-cover" />
        </span>
